...
# minimising the data transferred to the pan-London dataset #

minimise = {
    'List 1' : [],
    'List 2' : ['Organisation completing assessment'],
    'List 3' : ['Allocated Worker', 'Allocated Team'],
    'List 4' : ['Allocated Worker', 'Allocated Team'],
    'List 5' : ['Allocated Worker', 'Allocated Team'],
    'List 6' : ['Allocated Worker', 'Allocated Team'],
    'List 7' : ['Allocated Worker', 'Allocated Team'],
    'List 8' : ['Allocated Worker', 'Allocated Team'],
    'List 9' : ['Allocated Worker', 'Allocated Team'],
}
