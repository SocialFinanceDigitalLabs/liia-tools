...
def seniority_forecast_04():
   ...
   # ===== Read file ===== #
    ...
    for count in range(5):
        ...
        # Havering
        dfSen.loc[dfSen['LEAName'] == 'Havering', str(countYearNext)] = ((dfSen[str(
        ...
        dfSen.loc[dfSen['LEAName'] == 'Barking and Dagenham', str(countYearNext)] = (
            (dfSen[str(countYearBefore)] / p_df.loc[1, str(countYearBefore)])*p_df.loc[1, str(countYearNext)])
        # Redbridge
        dfSen.loc[dfSen['LEAName'] == 'Redbridge', str(countYearNext)] = ((dfSen[str(
            countYearBefore)] / p_df.loc[2, str(countYearBefore)])*p_df.loc[2, str(countYearNext)])
        # Newham
        dfSen.loc[dfSen['LEAName'] == 'Newham', str(countYearNext)] = ((dfSen[str(
            countYearBefore)] / p_df.loc[3, str(countYearBefore)])*p_df.loc[3, str(countYearNext)])
        # Tower Hamlets
        dfSen.loc[dfSen['LEAName'] == 'Tower Hamlets', str(countYearNext)] = ((dfSen[str(
        ...
        dfSen.loc[dfSen['LEAName'] == 'Waltham Forest', str(countYearNext)] = (
            (dfSen[str(countYearBefore)] / p_df.loc[5, str(countYearBefore)])*p_df.loc[5, str(countYearNext)])
